...
const Abouts = () => {
  ...
  return (
    <section
      id="abouts"
      className="relative min-h-screen w-full bg-slate-950 text-white px-6 py-40 overflow-hidden"
    >
      <div className="max-w-6xl mx-auto grid md:grid-cols-[1fr_3px_2fr] gap-16 relative">
        {/* LEFT — VERTICAL ABOUT */}
        <motion.div
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          className="sticky top-32 flex justify-center md:justify-end"
        >
          <div className="relative -translate-x-6 md:-translate-x-12">
            <span
              className="
                block
        ...
        <div className="flex flex-col gap-20">
          ...
          >
            <a
              ...
              className="text-lg text-blue-300 underline hover:text-cyan-300 transition"
            >
